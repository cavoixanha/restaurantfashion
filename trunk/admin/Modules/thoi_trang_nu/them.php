	...
	<div class="top" style="margin-left: 50px">
		<table width="400" border="1" cellpadding="1" style="text-align: left">
			...
			<tr>
				...
				<td><label for="size"></label> <input type="text" name="size"
					id="size"></td>
			</tr>
			<tr>
				<th scope="row">Giới tính</th>
				<td><label for="gioi_tinh"></label> <input type="text"
					name="gioi_tinh" id="gioi_tinh"></td>
			</tr>
			<tr>
				<th scope="row">Giá</th>
				<td><label for="gia"></label> <input type="text" name="gia" id="gia"></td>
			</tr>
			<tr>
				<th scope="row">Số lượng</th>
				<td><label for="so_luong"></label> <input type="text"
					name="so_luong" id="so_luong"></td>
			</tr>
			<tr>
				<th scope="row">Phần trăm Sale</th>
				<td><label for="phan_tram_giam"></label> <input type="text"
					name="phan_tram_giam" id="phan_tram_giam"></td>
			</tr>
			<tr>
				<th scope="row">Tiêu đề</th>
				<td><label for="tieu_de"></label> <input type="text" name="tieu_de"
					id="tieu_de"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><label for="noi_dung"></label> <input type="text"
					name="noi_dung" id="noi_dung"></td>
			</tr>
			<tr>
				<th scope="row">Ngày nhập</th>
				<td><label for="ngay_nhap"></label> <input type="text"
					name="ngay_nhap" id="ngay_nhap"></td>
			</tr>
