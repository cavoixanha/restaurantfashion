		...
		<div class="wrapper">
			<div class="content">
				<div id="form_wrapper" class="form_wrapper">
					<form class="register" action="xuly.php?ac=register">
						<h3>Đăng ký</h3>
						<div class="column">
							<div>
								<label>Họ:</label> <input type="text" /> <span class="error">This
									is an error</span>
							</div>
							<div>
						...
						<div class="bottom">
							<input type="submit" value="Đăng ký" /> <a href="login.php"
								rel="login" class="linkform">Bạn đã có tài khoản? Đăng nhập tại
								đây</a>
							<div class="clear"></div>
						</div>
					</form>
					<form class="login active" action="modules/xuly.php?ac=login" method="post">
						<h3>Đăng nhập</h3>
						<div>
							<label>Tên đăng nhập:</label> <input type="text" name="username" /> <span
								class="error">This is an error</span>
						</div>
						<div>
							<label>Mật khẩu: <a href="forgot_password.php"
								rel="forgot_password" class="forgot linkform">Bận quên mật khẩu?</a></label>
							<input type="password" name="password" /> <span class="error">This is an error</span>
						</div>
						<div class="bottom">
							<div class="remember">
							...
							<a href="register.php" rel="register" class="linkform">Bạn chưa có
					...
					<form class="forgot_password" action="xuly.php?ac=forgot_pass">
						...
						<div class="bottom">
							<input type="submit" value="Gửi yêu cầu"></input> <a
								href="login.php" rel="login" class="linkform">Bạn đã là thành
								viên? Đăng nhập tại đây</a> <a href="register.php"
